...
> {cmd:"b2b.district.search", 常规搜索条件, c_city_id}
 ...
 *
 */
public class DistrictSearch extends Search {
	 ...
	 * key: 是要补充到sql where 部分的clause语句内容，比如 "c_city_id=?"
	...
	protected HashMap<String, Object> reviseSearchCondition(JSONObject jo) throws Exception{
		...
		Table table=manager.getTable("district");
