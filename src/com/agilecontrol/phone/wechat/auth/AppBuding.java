...
public class AppBuding extends AppWeChatAuth {
	...
	protected Object accept(JSONObject json) throws Exception {
		...
		try{
			...
			AppBudingAuth aba=new AppBudingAuth(jedis, conn, event.getContext().getHttpServletRequest(), this.event.getContext().getHttpServletResponse());
