...
public abstract class AndroidWeChatAuth extends CmdHandler {
	...
	public AndroidWeChatAuth() {
		/*
		 * TODO Can not get values from ad_param on buding(100.18:7700) server.
		 * Write here temporally. Remove these later.
		 */
		
		//开放平台
		appid = ConfigValues.get(KEY_APP_ID, "wxed4204412f02b48d");
		secret = ConfigValues.get(KEY_SECRET,"43b8501ac8745c5a43c8d04df7b4f2b9");
